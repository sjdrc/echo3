#ifndef _ECHO_WINDOWSEXECUTIONMODEL_H_
#define _ECHO_WINDOWSEXECUTIONMODEL_H_

#include <echo/Kernel/ExecutionModel.h>

namespace Echo
{
	class WindowsExecutionModel : public ExecutionModel
	{
	public:
		WindowsExecutionModel();
		virtual ~WindowsExecutionModel();
