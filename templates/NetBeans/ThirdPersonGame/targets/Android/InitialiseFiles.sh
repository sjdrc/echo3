...
ECHO_ANDROID_TEMPLATE_APPLICATION_LOWER_CLASS_NAME="thirdpersongame"
ECHO_ANDROID_TEMPLATE_APPLICATION_CLASS_NAME="ThirdPersonGame"
ECHO_ANDROID_TEMPLATE_APPLICATION_DISPLAY_NAME="ThirdPersonGame"
ECHO_ANDROID_TEMPLATE_PACKAGE_NAME="au.com.emblementertainment.thirdpersongame"
