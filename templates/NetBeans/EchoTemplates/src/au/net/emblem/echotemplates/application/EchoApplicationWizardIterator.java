 ...
 */
package au.net.emblem.echotemplates.application;
...
@TemplateRegistration(folder = "Project/Native", category = "Echo C++ Projects", position=1, displayName = "Echo Application", description = "EchoApplicationDescription.html", iconBase = "au/net/emblem/echotemplates/application/EchoApplication.png", content = "EchoApplicationProject.zip")
public class EchoApplicationWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {

    private int index;
    private WizardDescriptor.Panel[] panels;
    private WizardDescriptor wiz;

    public EchoApplicationWizardIterator() {
    }

    public static EchoApplicationWizardIterator createIterator() {
        return new EchoApplicationWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new EchoApplicationWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(EchoApplicationWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
    ...
    private static void parseFile(FileObject fo, ZipInputStream str, String newFileName, String projectName, String codeSafeProjectName) throws IOException {
        try {
            ...
            //byte[] charBuffer = new byte[4096];
            //int bytesRead = bais.read(charBuffer);
            String wholeFile= new String(baos.toByteArray(),"UTF-8");
            //while(bytesRead!=-1)
            //{
            //    wholeFile+=charBuffer;
            //    bytesRead = bais.read(charBuffer);
            //}
