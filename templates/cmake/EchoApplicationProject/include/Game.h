#ifndef _MYPROJECTAPPLICATION_GAME_H_
#define _MYPROJECTAPPLICATION_GAME_H_
...
namespace MyProject
{
	...
	{
	public:
		Game(shared_ptr<Application> application, shared_ptr<FunctionBinder> appFunctions);
		~Game();
