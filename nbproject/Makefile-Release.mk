...
${OBJECTDIR}/src/Platforms/Qt/Platform.o: src/Platforms/Qt/Platform.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -DBT_USE_DOUBLE_PRECISION -DECHO_JPEG_SUPPORT_ENABLED -DECHO_PLATFORM_LINUX -DECHO_PNG_SUPPORT_ENABLED -Iinclude -Iinclude/echo/generated -Idependencies/opt/linux/include/freetype2 -Idependencies/opt/linux/include -Idependencies/opt/linux/include/bullet `pkg-config --cflags gtkmm-2.4` `pkg-config --cflags gtkglextmm-1.2` `pkg-config --cflags sigc++-2.0` `pkg-config --cflags libmodplug` `pkg-config --cflags ogg` `pkg-config --cflags Qt5Core` `pkg-config --cflags Qt5Gui` `pkg-config --cflags Qt5OpenGL` -std=c++14  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Qt/Platform.o src/Platforms/Qt/Platform.cpp
