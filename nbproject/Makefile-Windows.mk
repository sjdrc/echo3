...
# Macros
CND_PLATFORM=Windows_Cross_Compiler-Linux
CND_DLIB_EXT=so
CND_CONF=Windows
CND_DISTDIR=dist
CND_BUILDDIR=build
...
OBJECTFILES= \
	...
	${OBJECTDIR}/src/Platforms/Windows/Platform.o \
	${OBJECTDIR}/src/Platforms/Windows/SWindow.o \
	${OBJECTDIR}/src/Platforms/Windows/SystemInformation.o \
	${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel.o \
	${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow.o \
	${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard.o \
	${OBJECTDIR}/src/Platforms/Windows/WindowsMouse.o \
...
# CC Compiler Flags
CCFLAGS=--sysroot=/usr/i686-w64-mingw32
CXXFLAGS=--sysroot=/usr/i686-w64-mingw32
...
${OBJECTDIR}/src/Animation/Animation.o: src/Animation/Animation.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Animation/Animation.o src/Animation/Animation.cpp
...
${OBJECTDIR}/src/Application.o: src/Application.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Application.o src/Application.cpp

${OBJECTDIR}/src/Audio/Audio.o: src/Audio/Audio.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Audio
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Audio/Audio.o src/Audio/Audio.cpp

${OBJECTDIR}/src/Audio/AudioBuffer.o: src/Audio/AudioBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Audio
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Audio/AudioBuffer.o src/Audio/AudioBuffer.cpp

${OBJECTDIR}/src/Audio/AudioPlayer.o: src/Audio/AudioPlayer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Audio
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Audio/AudioPlayer.o src/Audio/AudioPlayer.cpp

${OBJECTDIR}/src/Audio/AudioSource.o: src/Audio/AudioSource.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Audio
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Audio/AudioSource.o src/Audio/AudioSource.cpp

${OBJECTDIR}/src/Audio/AudioStream.o: src/Audio/AudioStream.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Audio
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Audio/AudioStream.o src/Audio/AudioStream.cpp

${OBJECTDIR}/src/Chrono/CPUTimer.o: src/Chrono/CPUTimer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Chrono
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Chrono/CPUTimer.o src/Chrono/CPUTimer.cpp

${OBJECTDIR}/src/Chrono/Chrono.o: src/Chrono/Chrono.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Chrono
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Chrono/Chrono.o src/Chrono/Chrono.cpp

${OBJECTDIR}/src/Chrono/FrameRateLimiter.o: src/Chrono/FrameRateLimiter.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Chrono
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Chrono/FrameRateLimiter.o src/Chrono/FrameRateLimiter.cpp

${OBJECTDIR}/src/FileSystem/File.o: src/FileSystem/File.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/File.o src/FileSystem/File.cpp

${OBJECTDIR}/src/FileSystem/FileReferenceEncrypted.o: src/FileSystem/FileReferenceEncrypted.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileReferenceEncrypted.o src/FileSystem/FileReferenceEncrypted.cpp

${OBJECTDIR}/src/FileSystem/FileReferenceFile.o: src/FileSystem/FileReferenceFile.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileReferenceFile.o src/FileSystem/FileReferenceFile.cpp

${OBJECTDIR}/src/FileSystem/FileReferenceMemory.o: src/FileSystem/FileReferenceMemory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileReferenceMemory.o src/FileSystem/FileReferenceMemory.cpp

${OBJECTDIR}/src/FileSystem/FileReferenceVFS.o: src/FileSystem/FileReferenceVFS.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileReferenceVFS.o src/FileSystem/FileReferenceVFS.cpp

${OBJECTDIR}/src/FileSystem/FileSystem.o: src/FileSystem/FileSystem.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileSystem.o src/FileSystem/FileSystem.cpp

${OBJECTDIR}/src/FileSystem/FileSystemSource.o: src/FileSystem/FileSystemSource.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileSystemSource.o src/FileSystem/FileSystemSource.cpp

${OBJECTDIR}/src/FileSystem/FileSystemSourceEncrypted.o: src/FileSystem/FileSystemSourceEncrypted.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileSystemSourceEncrypted.o src/FileSystem/FileSystemSourceEncrypted.cpp

${OBJECTDIR}/src/FileSystem/FileSystemSourceFile.o: src/FileSystem/FileSystemSourceFile.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileSystemSourceFile.o src/FileSystem/FileSystemSourceFile.cpp

${OBJECTDIR}/src/FileSystem/FileSystemSourceMemory.o: src/FileSystem/FileSystemSourceMemory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileSystemSourceMemory.o src/FileSystem/FileSystemSourceMemory.cpp

${OBJECTDIR}/src/FileSystem/FileSystemSourceVFS.o: src/FileSystem/FileSystemSourceVFS.cpp
	${MKDIR} -p ${OBJECTDIR}/src/FileSystem
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileSystem/FileSystemSourceVFS.o src/FileSystem/FileSystemSourceVFS.cpp

${OBJECTDIR}/src/GUI/Button.o: src/GUI/Button.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Button.o src/GUI/Button.cpp

${OBJECTDIR}/src/GUI/Container.o: src/GUI/Container.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Container.o src/GUI/Container.cpp

${OBJECTDIR}/src/GUI/Cursor.o: src/GUI/Cursor.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Cursor.o src/GUI/Cursor.cpp

${OBJECTDIR}/src/GUI/Element.o: src/GUI/Element.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Element.o src/GUI/Element.cpp

${OBJECTDIR}/src/GUI/GUI.o: src/GUI/GUI.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/GUI.o src/GUI/GUI.cpp

${OBJECTDIR}/src/GUI/Image.o: src/GUI/Image.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Image.o src/GUI/Image.cpp

${OBJECTDIR}/src/GUI/Layout.o: src/GUI/Layout.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Layout.o src/GUI/Layout.cpp

${OBJECTDIR}/src/GUI/Menu.o: src/GUI/Menu.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Menu.o src/GUI/Menu.cpp

${OBJECTDIR}/src/GUI/Screen.o: src/GUI/Screen.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Screen.o src/GUI/Screen.cpp

${OBJECTDIR}/src/GUI/Text.o: src/GUI/Text.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/Text.o src/GUI/Text.cpp

${OBJECTDIR}/src/GUI/TextBox.o: src/GUI/TextBox.cpp
	${MKDIR} -p ${OBJECTDIR}/src/GUI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GUI/TextBox.o src/GUI/TextBox.cpp

${OBJECTDIR}/src/Graphics/Camera.o: src/Graphics/Camera.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Camera.o src/Graphics/Camera.cpp

${OBJECTDIR}/src/Graphics/CameraDollies.o: src/Graphics/CameraDollies.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/CameraDollies.o src/Graphics/CameraDollies.cpp

${OBJECTDIR}/src/Graphics/Colour.o: src/Graphics/Colour.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Colour.o src/Graphics/Colour.cpp

${OBJECTDIR}/src/Graphics/ElementBuffer.o: src/Graphics/ElementBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/ElementBuffer.o src/Graphics/ElementBuffer.cpp

${OBJECTDIR}/src/Graphics/Frustum.o: src/Graphics/Frustum.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Frustum.o src/Graphics/Frustum.cpp

${OBJECTDIR}/src/Graphics/Light.o: src/Graphics/Light.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Light.o src/Graphics/Light.cpp

${OBJECTDIR}/src/Graphics/Material.o: src/Graphics/Material.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Material.o src/Graphics/Material.cpp

${OBJECTDIR}/src/Graphics/MaterialAnimation.o: src/Graphics/MaterialAnimation.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/MaterialAnimation.o src/Graphics/MaterialAnimation.cpp

${OBJECTDIR}/src/Graphics/Mesh.o: src/Graphics/Mesh.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Mesh.o src/Graphics/Mesh.cpp

${OBJECTDIR}/src/Graphics/MultiRenderer.o: src/Graphics/MultiRenderer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/MultiRenderer.o src/Graphics/MultiRenderer.cpp

${OBJECTDIR}/src/Graphics/MultipassRenderable.o: src/Graphics/MultipassRenderable.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/MultipassRenderable.o src/Graphics/MultipassRenderable.cpp

${OBJECTDIR}/src/Graphics/Node.o: src/Graphics/Node.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Node.o src/Graphics/Node.cpp

${OBJECTDIR}/src/Graphics/PrimitiveTypes.o: src/Graphics/PrimitiveTypes.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/PrimitiveTypes.o src/Graphics/PrimitiveTypes.cpp

${OBJECTDIR}/src/Graphics/RenderPass.o: src/Graphics/RenderPass.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/RenderPass.o src/Graphics/RenderPass.cpp

${OBJECTDIR}/src/Graphics/RenderTarget.o: src/Graphics/RenderTarget.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/RenderTarget.o src/Graphics/RenderTarget.cpp

${OBJECTDIR}/src/Graphics/RenderTargetNotifier.o: src/Graphics/RenderTargetNotifier.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/RenderTargetNotifier.o src/Graphics/RenderTargetNotifier.cpp

${OBJECTDIR}/src/Graphics/Renderable.o: src/Graphics/Renderable.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Renderable.o src/Graphics/Renderable.cpp

${OBJECTDIR}/src/Graphics/Renderer.o: src/Graphics/Renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Renderer.o src/Graphics/Renderer.cpp

${OBJECTDIR}/src/Graphics/Scene.o: src/Graphics/Scene.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Scene.o src/Graphics/Scene.cpp

${OBJECTDIR}/src/Graphics/SceneEntity.o: src/Graphics/SceneEntity.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/SceneEntity.o src/Graphics/SceneEntity.cpp

${OBJECTDIR}/src/Graphics/SceneRenderable.o: src/Graphics/SceneRenderable.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/SceneRenderable.o src/Graphics/SceneRenderable.cpp

${OBJECTDIR}/src/Graphics/Shader.o: src/Graphics/Shader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Shader.o src/Graphics/Shader.cpp

${OBJECTDIR}/src/Graphics/ShaderProgram.o: src/Graphics/ShaderProgram.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/ShaderProgram.o src/Graphics/ShaderProgram.cpp

${OBJECTDIR}/src/Graphics/SkyBox.o: src/Graphics/SkyBox.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/SkyBox.o src/Graphics/SkyBox.cpp

${OBJECTDIR}/src/Graphics/Sprite.o: src/Graphics/Sprite.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Sprite.o src/Graphics/Sprite.cpp

${OBJECTDIR}/src/Graphics/StereoscopicRenderer.o: src/Graphics/StereoscopicRenderer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/StereoscopicRenderer.o src/Graphics/StereoscopicRenderer.cpp

${OBJECTDIR}/src/Graphics/SubMesh.o: src/Graphics/SubMesh.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/SubMesh.o src/Graphics/SubMesh.cpp

${OBJECTDIR}/src/Graphics/Terrain.o: src/Graphics/Terrain.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Terrain.o src/Graphics/Terrain.cpp

${OBJECTDIR}/src/Graphics/TextMesh.o: src/Graphics/TextMesh.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/TextMesh.o src/Graphics/TextMesh.cpp

${OBJECTDIR}/src/Graphics/Texture.o: src/Graphics/Texture.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Texture.o src/Graphics/Texture.cpp

${OBJECTDIR}/src/Graphics/TextureUnit.o: src/Graphics/TextureUnit.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/TextureUnit.o src/Graphics/TextureUnit.cpp

${OBJECTDIR}/src/Graphics/VertexAttribute.o: src/Graphics/VertexAttribute.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/VertexAttribute.o src/Graphics/VertexAttribute.cpp

${OBJECTDIR}/src/Graphics/VertexBuffer.o: src/Graphics/VertexBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/VertexBuffer.o src/Graphics/VertexBuffer.cpp

${OBJECTDIR}/src/Graphics/Viewport.o: src/Graphics/Viewport.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Viewport.o src/Graphics/Viewport.cpp

${OBJECTDIR}/src/Input/GenericInputDevice.o: src/Input/GenericInputDevice.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/GenericInputDevice.o src/Input/GenericInputDevice.cpp

${OBJECTDIR}/src/Input/Input.o: src/Input/Input.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/Input.o src/Input/Input.cpp

${OBJECTDIR}/src/Input/InputDevice.o: src/Input/InputDevice.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/InputDevice.o src/Input/InputDevice.cpp

${OBJECTDIR}/src/Input/MappedInputDevice.o: src/Input/MappedInputDevice.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/MappedInputDevice.o src/Input/MappedInputDevice.cpp

${OBJECTDIR}/src/Input/MappedInputDeviceLoader.o: src/Input/MappedInputDeviceLoader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/MappedInputDeviceLoader.o src/Input/MappedInputDeviceLoader.cpp

${OBJECTDIR}/src/Input/OnScreenAnalogueStick.o: src/Input/OnScreenAnalogueStick.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/OnScreenAnalogueStick.o src/Input/OnScreenAnalogueStick.cpp

${OBJECTDIR}/src/Input/PseudoKeyboard.o: src/Input/PseudoKeyboard.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/PseudoKeyboard.o src/Input/PseudoKeyboard.cpp

${OBJECTDIR}/src/Input/PseudoMouse.o: src/Input/PseudoMouse.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Input
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input/PseudoMouse.o src/Input/PseudoMouse.cpp

${OBJECTDIR}/src/Kernel/ExecutionModel.o: src/Kernel/ExecutionModel.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Kernel
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kernel/ExecutionModel.o src/Kernel/ExecutionModel.cpp

${OBJECTDIR}/src/Kernel/Kernel.o: src/Kernel/Kernel.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Kernel
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kernel/Kernel.o src/Kernel/Kernel.cpp

${OBJECTDIR}/src/Kernel/Task.o: src/Kernel/Task.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Kernel
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kernel/Task.o src/Kernel/Task.cpp

${OBJECTDIR}/src/Kernel/TaskGroup.o: src/Kernel/TaskGroup.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Kernel
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kernel/TaskGroup.o src/Kernel/TaskGroup.cpp

${OBJECTDIR}/src/Kernel/TaskManager.o: src/Kernel/TaskManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Kernel
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kernel/TaskManager.o src/Kernel/TaskManager.cpp

${OBJECTDIR}/src/Kernel/Thread.o: src/Kernel/Thread.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Kernel
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kernel/Thread.o src/Kernel/Thread.cpp

${OBJECTDIR}/src/Logging/Logging.o: src/Logging/Logging.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Logging
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Logging/Logging.o src/Logging/Logging.cpp

${OBJECTDIR}/src/Maths/AxisAlignedBox.o: src/Maths/AxisAlignedBox.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/AxisAlignedBox.o src/Maths/AxisAlignedBox.cpp

${OBJECTDIR}/src/Maths/EchoMaths.o: src/Maths/EchoMaths.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/EchoMaths.o src/Maths/EchoMaths.cpp

${OBJECTDIR}/src/Maths/Geometry.o: src/Maths/Geometry.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/Geometry.o src/Maths/Geometry.cpp

${OBJECTDIR}/src/Maths/Matrix4.o: src/Maths/Matrix4.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/Matrix4.o src/Maths/Matrix4.cpp

${OBJECTDIR}/src/Maths/Plane.o: src/Maths/Plane.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/Plane.o src/Maths/Plane.cpp

${OBJECTDIR}/src/Maths/Quaternion.o: src/Maths/Quaternion.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/Quaternion.o src/Maths/Quaternion.cpp

${OBJECTDIR}/src/Maths/Vector4.o: src/Maths/Vector4.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Maths
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Maths/Vector4.o src/Maths/Vector4.cpp

${OBJECTDIR}/src/Network/Connection.o: src/Network/Connection.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/Connection.o src/Network/Connection.cpp

${OBJECTDIR}/src/Network/ConnectionDetails.o: src/Network/ConnectionDetails.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/ConnectionDetails.o src/Network/ConnectionDetails.cpp

${OBJECTDIR}/src/Network/DataPacket.o: src/Network/DataPacket.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/DataPacket.o src/Network/DataPacket.cpp

${OBJECTDIR}/src/Network/NetworkExecutionModel.o: src/Network/NetworkExecutionModel.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/NetworkExecutionModel.o src/Network/NetworkExecutionModel.cpp

${OBJECTDIR}/src/Network/NetworkManager.o: src/Network/NetworkManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/NetworkManager.o src/Network/NetworkManager.cpp

${OBJECTDIR}/src/Network/NetworkManagerUpdater.o: src/Network/NetworkManagerUpdater.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/NetworkManagerUpdater.o src/Network/NetworkManagerUpdater.cpp

${OBJECTDIR}/src/Network/NetworkSystem.o: src/Network/NetworkSystem.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/NetworkSystem.o src/Network/NetworkSystem.cpp

${OBJECTDIR}/src/Network/SocketNetworkSystem.o: src/Network/SocketNetworkSystem.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/SocketNetworkSystem.o src/Network/SocketNetworkSystem.cpp

${OBJECTDIR}/src/Network/TCPConnection.o: src/Network/TCPConnection.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/TCPConnection.o src/Network/TCPConnection.cpp

${OBJECTDIR}/src/Network/UDPConnection.o: src/Network/UDPConnection.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/UDPConnection.o src/Network/UDPConnection.cpp

${OBJECTDIR}/src/Network/WebSocketConnection.o: src/Network/WebSocketConnection.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/WebSocketConnection.o src/Network/WebSocketConnection.cpp

${OBJECTDIR}/src/Network/WebSocketNetworkSystem.o: src/Network/WebSocketNetworkSystem.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Network/WebSocketNetworkSystem.o src/Network/WebSocketNetworkSystem.cpp

${OBJECTDIR}/src/Physics/BulletDynamicMotionState.o: src/Physics/BulletDynamicMotionState.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletDynamicMotionState.o src/Physics/BulletDynamicMotionState.cpp

${OBJECTDIR}/src/Physics/BulletFactory.o: src/Physics/BulletFactory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletFactory.o src/Physics/BulletFactory.cpp

${OBJECTDIR}/src/Physics/BulletKinematicMotionState.o: src/Physics/BulletKinematicMotionState.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletKinematicMotionState.o src/Physics/BulletKinematicMotionState.cpp

${OBJECTDIR}/src/Physics/BulletMeshDebugDrawer.o: src/Physics/BulletMeshDebugDrawer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletMeshDebugDrawer.o src/Physics/BulletMeshDebugDrawer.cpp

${OBJECTDIR}/src/Physics/BulletMeshPhysicsShape.o: src/Physics/BulletMeshPhysicsShape.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletMeshPhysicsShape.o src/Physics/BulletMeshPhysicsShape.cpp

${OBJECTDIR}/src/Physics/BulletMotionState.o: src/Physics/BulletMotionState.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletMotionState.o src/Physics/BulletMotionState.cpp

${OBJECTDIR}/src/Physics/BulletPhysicsShape.o: src/Physics/BulletPhysicsShape.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletPhysicsShape.o src/Physics/BulletPhysicsShape.cpp

${OBJECTDIR}/src/Physics/BulletPhysicsWorld.o: src/Physics/BulletPhysicsWorld.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletPhysicsWorld.o src/Physics/BulletPhysicsWorld.cpp

${OBJECTDIR}/src/Physics/BulletRigidBody.o: src/Physics/BulletRigidBody.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/BulletRigidBody.o src/Physics/BulletRigidBody.cpp

${OBJECTDIR}/src/Physics/MotionState.o: src/Physics/MotionState.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/MotionState.o src/Physics/MotionState.cpp

${OBJECTDIR}/src/Physics/PhysicsBody.o: src/Physics/PhysicsBody.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/PhysicsBody.o src/Physics/PhysicsBody.cpp

${OBJECTDIR}/src/Physics/PhysicsShape.o: src/Physics/PhysicsShape.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/PhysicsShape.o src/Physics/PhysicsShape.cpp

${OBJECTDIR}/src/Physics/PhysicsWorld.o: src/Physics/PhysicsWorld.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Physics/PhysicsWorld.o src/Physics/PhysicsWorld.cpp

${OBJECTDIR}/src/Platforms/AL/OpenALAudio.o: src/Platforms/AL/OpenALAudio.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/AL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/AL/OpenALAudio.o src/Platforms/AL/OpenALAudio.cpp

${OBJECTDIR}/src/Platforms/AL/OpenALAudioBuffer.o: src/Platforms/AL/OpenALAudioBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/AL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/AL/OpenALAudioBuffer.o src/Platforms/AL/OpenALAudioBuffer.cpp

${OBJECTDIR}/src/Platforms/Boost/BoostCPUTimer.o: src/Platforms/Boost/BoostCPUTimer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Boost
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Boost/BoostCPUTimer.o src/Platforms/Boost/BoostCPUTimer.cpp

${OBJECTDIR}/src/Platforms/Boost/BoostMutex.o: src/Platforms/Boost/BoostMutex.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Boost
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Boost/BoostMutex.o src/Platforms/Boost/BoostMutex.cpp

${OBJECTDIR}/src/Platforms/Boost/BoostThread.o: src/Platforms/Boost/BoostThread.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Boost
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Boost/BoostThread.o src/Platforms/Boost/BoostThread.cpp
...
${OBJECTDIR}/src/Platforms/GL/FragmentShaderManager.o: src/Platforms/GL/FragmentShaderManager.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/GL/FragmentShaderManager.o src/Platforms/GL/FragmentShaderManager.cpp

${OBJECTDIR}/src/Platforms/GL/GLRenderTarget.o: src/Platforms/GL/GLRenderTarget.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/GL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/GL/GLRenderTarget.o src/Platforms/GL/GLRenderTarget.cpp

${OBJECTDIR}/src/Platforms/GL/GLShader.o: src/Platforms/GL/GLShader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/GL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/GL/GLShader.o src/Platforms/GL/GLShader.cpp

${OBJECTDIR}/src/Platforms/GL/GLShaderProgram.o: src/Platforms/GL/GLShaderProgram.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/GL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/GL/GLShaderProgram.o src/Platforms/GL/GLShaderProgram.cpp

${OBJECTDIR}/src/Platforms/GL/GLTexture.o: src/Platforms/GL/GLTexture.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/GL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/GL/GLTexture.o src/Platforms/GL/GLTexture.cpp

${OBJECTDIR}/src/Platforms/GL/VertexShaderManager.o: src/Platforms/GL/VertexShaderManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/GL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/GL/VertexShaderManager.o src/Platforms/GL/VertexShaderManager.cpp

${OBJECTDIR}/src/Platforms/Windows/Platform.o: src/Platforms/Windows/Platform.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/Platform.o src/Platforms/Windows/Platform.cpp

${OBJECTDIR}/src/Platforms/Windows/SWindow.o: src/Platforms/Windows/SWindow.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/SWindow.o src/Platforms/Windows/SWindow.cpp

${OBJECTDIR}/src/Platforms/Windows/SystemInformation.o: src/Platforms/Windows/SystemInformation.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/SystemInformation.o src/Platforms/Windows/SystemInformation.cpp

${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel.o: src/Platforms/Windows/WindowsExecutionModel.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel.o src/Platforms/Windows/WindowsExecutionModel.cpp

${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow.o: src/Platforms/Windows/WindowsGLWindow.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow.o src/Platforms/Windows/WindowsGLWindow.cpp

${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard.o: src/Platforms/Windows/WindowsKeyboard.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard.o src/Platforms/Windows/WindowsKeyboard.cpp

${OBJECTDIR}/src/Platforms/Windows/WindowsMouse.o: src/Platforms/Windows/WindowsMouse.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsMouse.o src/Platforms/Windows/WindowsMouse.cpp

${OBJECTDIR}/src/Resource/3dsReader.o: src/Resource/3dsReader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/3dsReader.o src/Resource/3dsReader.cpp

${OBJECTDIR}/src/Resource/BitmapLoader.o: src/Resource/BitmapLoader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/BitmapLoader.o src/Resource/BitmapLoader.cpp

${OBJECTDIR}/src/Resource/FontManager.o: src/Resource/FontManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/FontManager.o src/Resource/FontManager.cpp

${OBJECTDIR}/src/Resource/MaterialManager.o: src/Resource/MaterialManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/MaterialManager.o src/Resource/MaterialManager.cpp

${OBJECTDIR}/src/Resource/MeshManager.o: src/Resource/MeshManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/MeshManager.o src/Resource/MeshManager.cpp

${OBJECTDIR}/src/Resource/MeshReader.o: src/Resource/MeshReader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/MeshReader.o src/Resource/MeshReader.cpp

${OBJECTDIR}/src/Resource/OggAudioSource.o: src/Resource/OggAudioSource.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/OggAudioSource.o src/Resource/OggAudioSource.cpp

${OBJECTDIR}/src/Resource/PNGLoader.o: src/Resource/PNGLoader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/PNGLoader.o src/Resource/PNGLoader.cpp

${OBJECTDIR}/src/Resource/RIFFReader.o: src/Resource/RIFFReader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/RIFFReader.o src/Resource/RIFFReader.cpp

${OBJECTDIR}/src/Resource/ResourceManager.o: src/Resource/ResourceManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/ResourceManager.o src/Resource/ResourceManager.cpp

${OBJECTDIR}/src/Resource/SkeletonManager.o: src/Resource/SkeletonManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/SkeletonManager.o src/Resource/SkeletonManager.cpp

${OBJECTDIR}/src/Resource/SkeletonReader.o: src/Resource/SkeletonReader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/SkeletonReader.o src/Resource/SkeletonReader.cpp

${OBJECTDIR}/src/Resource/TextureLoader.o: src/Resource/TextureLoader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/TextureLoader.o src/Resource/TextureLoader.cpp

${OBJECTDIR}/src/Resource/TextureManager.o: src/Resource/TextureManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/TextureManager.o src/Resource/TextureManager.cpp

${OBJECTDIR}/src/Resource/WavAudioSource.o: src/Resource/WavAudioSource.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/WavAudioSource.o src/Resource/WavAudioSource.cpp

${OBJECTDIR}/src/Resource/XMAudioSource.o: src/Resource/XMAudioSource.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Resource
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resource/XMAudioSource.o src/Resource/XMAudioSource.cpp

${OBJECTDIR}/src/Shell/Shell.o: src/Shell/Shell.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Shell
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Shell/Shell.o src/Shell/Shell.cpp

${OBJECTDIR}/src/Tile/TMXLoader.o: src/Tile/TMXLoader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Tile
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Tile/TMXLoader.o src/Tile/TMXLoader.cpp

${OBJECTDIR}/src/Tile/TileLayer.o: src/Tile/TileLayer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Tile
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Tile/TileLayer.o src/Tile/TileLayer.cpp

${OBJECTDIR}/src/Tile/TileLayerMesh.o: src/Tile/TileLayerMesh.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Tile
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Tile/TileLayerMesh.o src/Tile/TileLayerMesh.cpp

${OBJECTDIR}/src/Tile/TileMap.o: src/Tile/TileMap.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Tile
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Tile/TileMap.o src/Tile/TileMap.cpp

${OBJECTDIR}/src/Tile/TileSet.o: src/Tile/TileSet.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Tile
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Tile/TileSet.o src/Tile/TileSet.cpp

${OBJECTDIR}/src/Util/Configuration.o: src/Util/Configuration.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/Configuration.o src/Util/Configuration.cpp

${OBJECTDIR}/src/Util/ContextSwitcher.o: src/Util/ContextSwitcher.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/ContextSwitcher.o src/Util/ContextSwitcher.cpp

${OBJECTDIR}/src/Util/Parsers.o: src/Util/Parsers.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/Parsers.o src/Util/Parsers.cpp

${OBJECTDIR}/src/Util/RegEx.o: src/Util/RegEx.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/RegEx.o src/Util/RegEx.cpp

${OBJECTDIR}/src/Util/ScenePicker.o: src/Util/ScenePicker.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/ScenePicker.o src/Util/ScenePicker.cpp

${OBJECTDIR}/src/Util/StringSetter.o: src/Util/StringSetter.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/StringSetter.o src/Util/StringSetter.cpp

${OBJECTDIR}/src/Util/StringUtils.o: src/Util/StringUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/StringUtils.o src/Util/StringUtils.cpp

${OBJECTDIR}/src/Util/Texture.o: src/Util/Texture.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util/Texture.o src/Util/Texture.cpp

${OBJECTDIR}/src/generated/Font.pb.o: src/generated/Font.pb.cc
	${MKDIR} -p ${OBJECTDIR}/src/generated
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/generated/Font.pb.o src/generated/Font.pb.cc

${OBJECTDIR}/src/generated/GUI.pb.o: src/generated/GUI.pb.cc
	${MKDIR} -p ${OBJECTDIR}/src/generated
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/generated/GUI.pb.o src/generated/GUI.pb.cc

${OBJECTDIR}/src/generated/MappedInputDevice.pb.o: src/generated/MappedInputDevice.pb.cc
	${MKDIR} -p ${OBJECTDIR}/src/generated
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/generated/MappedInputDevice.pb.o src/generated/MappedInputDevice.pb.cc

${OBJECTDIR}/src/generated/Material.pb.o: src/generated/Material.pb.cc
	${MKDIR} -p ${OBJECTDIR}/src/generated
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/generated/Material.pb.o src/generated/Material.pb.cc
...
${TESTDIR}/TestFiles/f24: ${TESTDIR}/src/tests/AlphaRejectTest.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f24 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f7: ${TESTDIR}/src/tests/ApplicationTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f7 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f6: ${TESTDIR}/src/tests/AudioTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f6 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f31: ${TESTDIR}/src/tests/BulletPhysicsTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f31 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f12: ${TESTDIR}/src/tests/ConfigurationTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f12 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f33: ${TESTDIR}/src/tests/ContextSwitcherTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f33 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f29: ${TESTDIR}/src/tests/ConverterTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f29 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f8: ${TESTDIR}/src/tests/FontMapTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f8 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f3: ${TESTDIR}/src/tests/FunctionBinderTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f20: ${TESTDIR}/src/tests/GUITest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f20 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f5: ${TESTDIR}/src/tests/InputTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f5 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f15: ${TESTDIR}/src/tests/MaterialAnimationTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f15 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f27: ${TESTDIR}/src/tests/MenuTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f27 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f18: ${TESTDIR}/src/tests/MultiPassRenderTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f18 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f22: ${TESTDIR}/src/tests/MultiStageTexturing.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f22 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f11: ${TESTDIR}/src/tests/NetworkTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f11 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f34: ${TESTDIR}/src/tests/ParserTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f34 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f32: ${TESTDIR}/src/tests/ParticleTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f32 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f35: ${TESTDIR}/src/tests/PBRTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f35 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f2: ${TESTDIR}/src/tests/RenderTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f21: ${TESTDIR}/src/tests/ResourceTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f21 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f25: ${TESTDIR}/src/tests/ScissorTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f25 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f19: ${TESTDIR}/src/tests/ShaderTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f19 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f17: ${TESTDIR}/src/tests/ShellTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f17 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f14: ${TESTDIR}/src/tests/SkyBoxTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f14 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f30: ${TESTDIR}/src/tests/StringUtilsTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f30 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f28: ${TESTDIR}/src/tests/SystemInformationTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f28 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f1: ${TESTDIR}/src/tests/TaskTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f13: ${TESTDIR}/src/tests/TerrainTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f13 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f10: ${TESTDIR}/src/tests/TextRenderTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f10 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f23: ${TESTDIR}/src/tests/TileMapTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f23 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f16: ${TESTDIR}/src/tests/TimerTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f16 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f4: ${TESTDIR}/src/tests/TypeTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f4 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f9: ${TESTDIR}/src/tests/UTFStringTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f9 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   

${TESTDIR}/TestFiles/f26: ${TESTDIR}/src/tests/VertexBufferTests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f26 $^ ${LDLIBSOPTIONS}   -lpng12 -lboost_system -lboost_filesystem -lboost_regex `pkg-config --libs protobuf libmodplug vorbis gl gtkmm-2.4 gtkglextmm-1.2 sigc++-2.0 libmodplug ogg openal tinyxml glew vorbisfile`   


${TESTDIR}/src/tests/AlphaRejectTest.o: src/tests/AlphaRejectTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/AlphaRejectTest.o src/tests/AlphaRejectTest.cpp


${TESTDIR}/src/tests/ApplicationTest.o: src/tests/ApplicationTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ApplicationTest.o src/tests/ApplicationTest.cpp


${TESTDIR}/src/tests/AudioTests.o: src/tests/AudioTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/AudioTests.o src/tests/AudioTests.cpp


${TESTDIR}/src/tests/BulletPhysicsTest.o: src/tests/BulletPhysicsTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/BulletPhysicsTest.o src/tests/BulletPhysicsTest.cpp


${TESTDIR}/src/tests/ConfigurationTest.o: src/tests/ConfigurationTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ConfigurationTest.o src/tests/ConfigurationTest.cpp


${TESTDIR}/src/tests/ContextSwitcherTests.o: src/tests/ContextSwitcherTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ContextSwitcherTests.o src/tests/ContextSwitcherTests.cpp


${TESTDIR}/src/tests/ConverterTests.o: src/tests/ConverterTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ConverterTests.o src/tests/ConverterTests.cpp


${TESTDIR}/src/tests/FontMapTest.o: src/tests/FontMapTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/FontMapTest.o src/tests/FontMapTest.cpp


${TESTDIR}/src/tests/FunctionBinderTests.o: src/tests/FunctionBinderTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/FunctionBinderTests.o src/tests/FunctionBinderTests.cpp


${TESTDIR}/src/tests/GUITest.o: src/tests/GUITest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/GUITest.o src/tests/GUITest.cpp


${TESTDIR}/src/tests/InputTest.o: src/tests/InputTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/InputTest.o src/tests/InputTest.cpp


${TESTDIR}/src/tests/MaterialAnimationTest.o: src/tests/MaterialAnimationTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/MaterialAnimationTest.o src/tests/MaterialAnimationTest.cpp


${TESTDIR}/src/tests/MenuTest.o: src/tests/MenuTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/MenuTest.o src/tests/MenuTest.cpp


${TESTDIR}/src/tests/MultiPassRenderTest.o: src/tests/MultiPassRenderTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/MultiPassRenderTest.o src/tests/MultiPassRenderTest.cpp


${TESTDIR}/src/tests/MultiStageTexturing.o: src/tests/MultiStageTexturing.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/MultiStageTexturing.o src/tests/MultiStageTexturing.cpp


${TESTDIR}/src/tests/NetworkTests.o: src/tests/NetworkTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/NetworkTests.o src/tests/NetworkTests.cpp


${TESTDIR}/src/tests/ParserTests.o: src/tests/ParserTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ParserTests.o src/tests/ParserTests.cpp


${TESTDIR}/src/tests/ParticleTest.o: src/tests/ParticleTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ParticleTest.o src/tests/ParticleTest.cpp


${TESTDIR}/src/tests/PBRTests.o: src/tests/PBRTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/PBRTests.o src/tests/PBRTests.cpp


${TESTDIR}/src/tests/RenderTest.o: src/tests/RenderTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/RenderTest.o src/tests/RenderTest.cpp


${TESTDIR}/src/tests/ResourceTests.o: src/tests/ResourceTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ResourceTests.o src/tests/ResourceTests.cpp


${TESTDIR}/src/tests/ScissorTest.o: src/tests/ScissorTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ScissorTest.o src/tests/ScissorTest.cpp


${TESTDIR}/src/tests/ShaderTest.o: src/tests/ShaderTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ShaderTest.o src/tests/ShaderTest.cpp


${TESTDIR}/src/tests/ShellTest.o: src/tests/ShellTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/ShellTest.o src/tests/ShellTest.cpp


${TESTDIR}/src/tests/SkyBoxTest.o: src/tests/SkyBoxTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/SkyBoxTest.o src/tests/SkyBoxTest.cpp


${TESTDIR}/src/tests/StringUtilsTest.o: src/tests/StringUtilsTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/StringUtilsTest.o src/tests/StringUtilsTest.cpp


${TESTDIR}/src/tests/SystemInformationTest.o: src/tests/SystemInformationTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/SystemInformationTest.o src/tests/SystemInformationTest.cpp


${TESTDIR}/src/tests/TaskTests.o: src/tests/TaskTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/TaskTests.o src/tests/TaskTests.cpp


${TESTDIR}/src/tests/TerrainTest.o: src/tests/TerrainTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/TerrainTest.o src/tests/TerrainTest.cpp


${TESTDIR}/src/tests/TextRenderTest.o: src/tests/TextRenderTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/TextRenderTest.o src/tests/TextRenderTest.cpp


${TESTDIR}/src/tests/TileMapTests.o: src/tests/TileMapTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/TileMapTests.o src/tests/TileMapTests.cpp


${TESTDIR}/src/tests/TimerTests.o: src/tests/TimerTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/TimerTests.o src/tests/TimerTests.cpp


${TESTDIR}/src/tests/TypeTests.o: src/tests/TypeTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/TypeTests.o src/tests/TypeTests.cpp


${TESTDIR}/src/tests/UTFStringTest.o: src/tests/UTFStringTest.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/UTFStringTest.o src/tests/UTFStringTest.cpp


${TESTDIR}/src/tests/VertexBufferTests.o: src/tests/VertexBufferTests.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/VertexBufferTests.o src/tests/VertexBufferTests.cpp
...
${OBJECTDIR}/src/Platforms/Windows/Platform_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/Platform.o src/Platforms/Windows/Platform.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/Platform.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/Platform_nomain.o src/Platforms/Windows/Platform.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/Platform.o ${OBJECTDIR}/src/Platforms/Windows/Platform_nomain.o;\
	fi

${OBJECTDIR}/src/Platforms/Windows/SWindow_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/SWindow.o src/Platforms/Windows/SWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/SWindow.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/SWindow_nomain.o src/Platforms/Windows/SWindow.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/SWindow.o ${OBJECTDIR}/src/Platforms/Windows/SWindow_nomain.o;\
	fi

${OBJECTDIR}/src/Platforms/Windows/SystemInformation_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/SystemInformation.o src/Platforms/Windows/SystemInformation.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/SystemInformation.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/SystemInformation_nomain.o src/Platforms/Windows/SystemInformation.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/SystemInformation.o ${OBJECTDIR}/src/Platforms/Windows/SystemInformation_nomain.o;\
	fi

${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel.o src/Platforms/Windows/WindowsExecutionModel.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel_nomain.o src/Platforms/Windows/WindowsExecutionModel.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel.o ${OBJECTDIR}/src/Platforms/Windows/WindowsExecutionModel_nomain.o;\
	fi

${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow.o src/Platforms/Windows/WindowsGLWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow_nomain.o src/Platforms/Windows/WindowsGLWindow.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow.o ${OBJECTDIR}/src/Platforms/Windows/WindowsGLWindow_nomain.o;\
	fi

${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard.o src/Platforms/Windows/WindowsKeyboard.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard_nomain.o src/Platforms/Windows/WindowsKeyboard.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard.o ${OBJECTDIR}/src/Platforms/Windows/WindowsKeyboard_nomain.o;\
	fi

${OBJECTDIR}/src/Platforms/Windows/WindowsMouse_nomain.o: ${OBJECTDIR}/src/Platforms/Windows/WindowsMouse.o src/Platforms/Windows/WindowsMouse.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Platforms/Windows
	@NMOUTPUT=`${NM} ${OBJECTDIR}/src/Platforms/Windows/WindowsMouse.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DBOOST_USE_WINDOWS_H -DECHO_PLATFORM_WINDOWS -DGLEW_STATIC -DWINVER=0x0501 -Iinclude -Idependencies/opt/windowscross/include/freetype2 -Idependencies/opt/windowscross/include/bullet -Idependencies/opt/windowscross/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Platforms/Windows/WindowsMouse_nomain.o src/Platforms/Windows/WindowsMouse.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/src/Platforms/Windows/WindowsMouse.o ${OBJECTDIR}/src/Platforms/Windows/WindowsMouse_nomain.o;\
	fi
